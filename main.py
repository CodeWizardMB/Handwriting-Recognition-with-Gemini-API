...
if os.path.exists(file_to_upload):
    ...
    # Send message to recognize text
    response = chat_session.send_message("Please recognize the text in this file.")

    recognized_text = response.text
    print("Recognized Text:", recognized_text)

    # Correct grammar in the recognized text
    corrected_text = correct_grammar_with_languagetool(recognized_text)
    print("\nCorrected Text:", corrected_text)

    # Translate the corrected text
    preferred_language = "en"  # Set your preferred language code here
    translated_text = translate_text(corrected_text, preferred_language)
    print(f"\nTranslated Text: {translated_text}")

    # Ask the user if they want to start voice recognition
    print("Press 'v' to start voice recognition or any other key to exit.")
    key = input().lower()
